...
const pillar: PillarContent = {
  ...
  answerFirst:
    'La ristrutturazione edilizia è l\'intervento che rinnova o trasforma un edificio esistente senza demolirlo: può riguardare un solo appartamento o un intero immobile e va dal semplice rifacimento di impianti e finiture fino a interventi che modificano la distribuzione degli spazi. A seconda della portata dei lavori si autorizza con CILA, SCIA o, nei casi più incisivi, con Permesso di Costruire.',
  sections: [
    {
      heading: 'Quando serve una ristrutturazione e cosa comprende',
      body:
        'Si parla di ristrutturazione quando l\'intervento va oltre la manutenzione ordinaria o straordinaria e tocca la struttura, la distribuzione interna o l\'aspetto dell\'edificio esistente. Rientrano qui: rifacimento completo di impianti elettrico e idraulico, apertura o chiusura di vani, consolidamento strutturale, rifacimento di facciate e coperture, ridistribuzione degli spazi interni. Serve tipicamente quando l\'immobile è datato, poco efficiente dal punto di vista energetico, oppure quando si vuole cambiare la disposizione di una casa acquistata o ereditata. A differenza della manutenzione straordinaria, che si limita a rinnovare senza alterare in modo sostanziale gli spazi, la ristrutturazione può arrivare a modificare sagoma e volumi nei casi più estesi (ristrutturazione "pesante").',
    },
    {
      heading: 'Quale titolo edilizio serve per ristrutturare casa',
      body:
        'Il titolo richiesto dipende dalla portata dei lavori. Le ristrutturazioni "leggere", che non alterano sagoma, volumi o prospetti, si autorizzano con CILA (Comunicazione di Inizio Lavori Asseverata) se non toccano le parti strutturali, oppure con SCIA (Segnalazione Certificata di Inizio Attività) quando riguardano anche elementi strutturali o l\'intera unità immobiliare. Le ristrutturazioni "pesanti", che modificano sagoma, volumi, prospetti o la destinazione d\'uso dell\'edificio, richiedono invece il Permesso di Costruire. La scelta corretta del titolo va sempre verificata con un tecnico abilitato (architetto, ingegnere o geometra), perché dipende anche dal regolamento edilizio comunale e dalla zona urbanistica.',
    },
    {
      heading: 'Quanto costa ristrutturare casa',
      body:
        'Il costo di una ristrutturazione varia molto in base alla zona, allo stato di partenza dell\'immobile, alle finiture scelte e all\'impresa incaricata: i numeri che seguono sono range indicativi, non un preventivo. Una ristrutturazione "leggera" (impianti, pavimenti, bagno, tinteggiatura) si aggira orientativamente tra 300 e 700 euro al metro quadro. Una ristrutturazione completa che include anche modifiche alla distribuzione interna arriva tipicamente tra 600 e 1.200 euro al metro quadro. Una ristrutturazione "pesante", con interventi strutturali o ampliamenti, può superare i 1.000-2.000 euro al metro quadro. Sono spesso disponibili detrazioni fiscali per le ristrutturazioni edilizie: le aliquote e i requisiti cambiano nel tempo, quindi vanno verificati con un tecnico o commercialista e sul sito dell\'Agenzia delle Entrate prima di avviare i lavori. Per una stima affidabile serve sempre un preventivo scritto da un\'impresa o un tecnico dopo un sopralluogo.',
    },
  ],
  faq: [
    {
      q: 'Qual è la differenza tra ristrutturazione e manutenzione straordinaria?',
      a: 'La manutenzione straordinaria riguarda interventi di rinnovo che non alterano la distribuzione interna in modo sostanziale (es. rifacimento impianti, sostituzione infissi). La ristrutturazione può invece modificare la distribuzione degli spazi, aprire o chiudere vani, e nei casi più estesi anche la sagoma dell\'edificio.',
    },
    {
    ...
    },
    {
      ...
      a: 'Dipende dalla dimensione e dalla tipologia: una ristrutturazione di un singolo appartamento può durare 2-4 mesi, mentre la ristrutturazione di un intero edificio o condominio può richiedere 6-18 mesi.',
    },
    {
      q: 'Chi può presentare la pratica di ristrutturazione al Comune?',
