...
const pillar: PillarContent = {
  ...
  faq: [
    {
      q: "Qual è la differenza tra ampliamento e ristrutturazione?",
    ...
    },
    {
      ...
      a: "Di norma si', perché l'aumento di volumetria qualifica l'intervento come soggetto a PdC. Fanno eccezione gli ampliamenti di limitata entità consentiti da leggi regionali sul Piano Casa, quando la normativa regionale e il regolamento comunale prevedono un titolo più snello come la SCIA.",
    },
    {
    ...
    },
    {
      ...
      a: "Indicativamente da 800-1.500 euro al metro quadro per un corpo aggiunto semplice fino a 1.200-2.000 euro al metro quadro o oltre per una sopraelevazione con opere strutturali importanti. Il costo reale dipende da zona, complessità strutturale e finiture: serve sempre un preventivo su misura.",
    },
    {
      q: "L'ampliamento comporta oneri di urbanizzazione da pagare al Comune?",
      a: "Si', quando il titolo è il Permesso di Costruire è dovuto il contributo di costruzione (oneri di urbanizzazione e costo di costruzione), calcolato dal Comune sulla nuova volumetria realizzata.",
    },
  ],
  correlati: [
