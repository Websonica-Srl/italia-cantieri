...
const pillar: PillarContent = {
  ...
  faq: [
    {
      q: 'Qual è la differenza tra manutenzione ordinaria e straordinaria?',
    ...
    },
    {
      ...
      a: 'Sì, nella maggior parte dei casi. Sia la CILA sia la SCIA richiedono l\'asseverazione di un tecnico abilitato (architetto, ingegnere o geometra), che certifica la conformità urbanistica, edilizia e catastale dell\'intervento.',
    },
    {
      q: 'Manutenzione straordinaria e ristrutturazione sono la stessa cosa?',
      a: 'No. La manutenzione straordinaria rinnova o sostituisce parti dell\'edificio senza alterarne in modo sostanziale la distribuzione interna. La ristrutturazione può invece modificare la distribuzione degli spazi e, nei casi più estesi, anche sagoma e volumi.',
    },
    {
    ...
    },
    {
      ...
      a: 'Dipende dall\'entità dei lavori: interventi su un singolo impianto o su infissi possono richiedere da pochi giorni a poche settimane, mentre interventi più estesi con opere strutturali possono durare 1-3 mesi.',
    },
  ],
  correlati: [
