  ...
  faq: [
    {
      ...
      a: 'Il criterio principale è se l\'intervento tocca le parti strutturali dell\'edificio: se non le tocca (es. rifacimento impianti, infissi, tramezzi), di norma basta la CILA; se le coinvolge, senza pero\' modificare sagoma o volume, serve tipicamente la SCIA. La verifica definitiva spetta a un tecnico abilitato.',
    },
    {
      q: 'Cosa succede se presento il titolo sbagliato?',
      a: 'Se l\'intervento richiedeva un titolo più impegnativo di quello presentato, i lavori possono essere considerati irregolari e soggetti a sanzioni previste dal DPR 380/2001. Per questo la scelta tra CILA, SCIA e Permesso di Costruire va sempre valutata con un tecnico prima di iniziare.',
    },
    {
      q: 'CILA e SCIA hanno gli stessi costi?',
      a: 'Entrambe richiedono l\'onorario di un tecnico abilitato per relazione tecnica, asseverazione ed elaborati grafici: l\'importo dipende dalla complessità dell\'intervento, non dal tipo di titolo. La SCIA può comportare oneri aggiuntivi se dovuti in base al tipo di intervento.',
    },
    {
      q: 'Posso iniziare subito i lavori con SCIA o CILA?',
      a: 'Con la CILA sì, i lavori iniziano il giorno stesso della presentazione. Con la SCIA, in molti Comuni si può iniziare subito, ma il Comune mantiene un termine di 30 giorni per i controlli successivi (termine perentorio, art. 19 comma 6-bis L. 241/1990), a differenza del Permesso di Costruire che richiede autorizzazione preventiva.',
    },
    {
