...
const pillar: PillarContent = {
  ...
  slug: 'scia',
  titolo: 'SCIA',
  h1: 'SCIA: Segnalazione Certificata di Inizio Attività',
  answerFirst:
  ...
  faq: [
    {
      ...
      a: 'In molti casi i lavori possono iniziare dal giorno stesso della presentazione, ma il Comune ha un termine di 30 giorni (termine perentorio, art. 19 comma 6-bis L. 241/1990) per effettuare i controlli successivi. I tempi esatti dipendono dal regolamento edilizio comunale e dal tipo di intervento.',
    },
    {
      q: 'La SCIA scade?',
      a: 'La SCIA non ha una scadenza definita come il Permesso di Costruire, ma i lavori vanno eseguiti in un tempo ragionevole coerente con quanto dichiarato: è comunque opportuno verificare con il proprio tecnico eventuali termini specifici previsti dal Comune.',
    },
    {
      q: 'SCIA e CILA sono la stessa cosa?',
      a: 'No. La CILA copre interventi più semplici di manutenzione straordinaria non strutturale e non richiede attesa. La SCIA riguarda interventi più rilevanti, spesso su parti strutturali, ed è soggetta a un termine di controllo comunale.',
    },
    {
      q: 'Cosa succede se faccio lavori soggetti a SCIA senza presentarla?',
      a: 'I lavori sono irregolari e soggetti a sanzioni pecuniarie previste dal Testo Unico Edilizia, con possibile obbligo di ripristino dello stato dei luoghi nei casi più gravi. È possibile regolarizzare con una SCIA in sanatoria se l\'intervento risulta conforme.',
    },
    {
      q: 'Chi può presentare la SCIA?',
  ...
  metaTitle: 'SCIA edilizia: cos\'è, quando serve e come funziona',
  metaDescription:
    'Cos\'è la SCIA (Segnalazione Certificata di Inizio Attività): quando si usa, differenze con CILA e Permesso di Costruire, iter, tempi, costi e sanzioni.',
  ondata: 1,
};
