...
const pillar: PillarContent = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Se il titolo richiesto e' il Permesso di Costruire, si', e' dovuto il contributo di costruzione calcolato dal Comune sulla nuova destinazione. Con CILA o SCIA senza opere rilevanti, di norma non sono dovuti oneri di urbanizzazione, ma questo va verificato con lo Sportello Unico Edilizia del Comune competente.",
    },
    {
      q: "Bisogna aggiornare il catasto dopo un cambio di destinazione d'uso?",
      a: "Si', quando il cambio d'uso modifica la categoria catastale dell'immobile va presentata una variazione catastale all'Agenzia delle Entrate entro i termini di legge, indipendentemente dal titolo edilizio con cui e' stato autorizzato l'intervento.",
    },
  ],
  correlati: [
  ...
  metaDescription:
    "Cambio di destinazione d'uso: quando e' rilevante, quale titolo edilizio richiede (CILA, SCIA o Permesso di Costruire) e quanto costa indicativamente.",
  ondata: 2,
};
