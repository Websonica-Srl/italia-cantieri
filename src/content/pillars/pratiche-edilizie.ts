...
const pillar: PillarContent = {
  ...
  answerFirst:
    "Le pratiche edilizie sono l'insieme delle procedure con cui un intervento su un immobile viene comunicato o autorizzato dal Comune prima di iniziare i lavori. Il Testo Unico Edilizia (DPR 380/2001) prevede quattro regimi principali, in ordine crescente di complessità: edilizia libera (nessun titolo, art. 6), CILA (Comunicazione di Inizio Lavori Asseverata, art. 6-bis), SCIA (Segnalazione Certificata di Inizio Attività, art. 22-23) e Permesso di Costruire (art. 10). Il titolo corretto dipende dal tipo di intervento, dalla sua incidenza su struttura, sagoma, volumi e destinazione d'uso dell'edificio, e va sempre verificato con un tecnico abilitato prima di procedere.",
  sections: [
    {
      heading: 'I quattro titoli edilizi: panoramica',
      body:
        "L'edilizia libera (art. 6 DPR 380/2001) comprende gli interventi che non richiedono alcun titolo ne' comunicazione, come manutenzione ordinaria, piccole riparazioni, opere temporanee o alcuni interventi di efficientamento energetico specificamente individuati dalla legge: restano comunque soggetti al rispetto delle norme di sicurezza, antisismiche, igienico-sanitarie e dei regolamenti condominiali. La CILA (art. 6-bis) è il titolo più leggero tra quelli che richiedono una comunicazione: si usa per manutenzione straordinaria che non tocca le parti strutturali, e permette di iniziare i lavori il giorno stesso della presentazione. La SCIA (art. 22-23) copre interventi più incisivi, come ristrutturazioni che toccano elementi strutturali o l'intera unità immobiliare, e richiede un termine di attesa prima dell'avvio lavori. Il Permesso di Costruire (art. 10) è il titolo più completo, necessario per nuove costruzioni, ampliamenti volumetrici, ristrutturazioni \"pesanti\" che modificano sagoma o volumi, e cambi di destinazione d'uso urbanisticamente rilevanti con impatto significativo.",
    },
    {
      heading: 'Come scegliere il titolo giusto',
      body:
        "La scelta del titolo dipende da tre fattori principali: cosa cambia fisicamente nell'edificio (finiture, impianti, struttura, sagoma, volumi), se cambia la destinazione d'uso rispetto a quella autorizzata, e se l'immobile è soggetto a vincoli (paesaggistici, storici, condominiali) che possono richiedere autorizzazioni aggiuntive indipendentemente dal titolo edilizio di base. In generale: interventi che non toccano la struttura e non alterano gli spazi in modo sostanziale rientrano in edilizia libera o CILA; interventi che toccano elementi strutturali o l'intera unità immobiliare, ma senza aumento di volumetria, rientrano nella SCIA; interventi che aumentano la volumetria, modificano sagoma o prospetti, o comportano un cambio di destinazione d'uso rilevante, richiedono il Permesso di Costruire. Questa è una guida di orientamento generale: la qualificazione esatta dipende anche dal regolamento edilizio del Comune specifico e dalla normativa regionale, quindi va sempre confermata con un tecnico abilitato (architetto, ingegnere o geometra) prima di presentare la pratica.",
    },
    {
      heading: "L'iter generale delle pratiche edilizie",
      body:
        "Tutte le pratiche edilizie soggette a comunicazione o autorizzazione si presentano allo Sportello Unico Edilizia (SUE) del Comune competente, generalmente per via telematica, a cura di un tecnico abilitato che redige la relazione tecnica e gli elaborati di progetto. Le tempistiche cambiano molto in base al titolo: la CILA non ha termini di attesa (i lavori iniziano subito dopo la presentazione), la SCIA ha un termine di controllo di 30 giorni perentori (art. 19 comma 6-bis L. 241/1990), fermo restando che gli immobili vincolati richiedono un'autorizzazione paesaggistica o storica separata e preliminare, il Permesso di Costruire richiede tipicamente 60-90 giorni per il rilascio, salvo proroghe. A conclusione dei lavori, per tutti i titoli è generalmente richiesta la presentazione della fine lavori e, se previsto, dell'agibilità, oltre all'eventuale aggiornamento catastale. Presentare la pratica sbagliata, o non presentarla affatto quando dovuta, espone a sanzioni che vanno da importi pecuniari fissi fino, nei casi più gravi, alla demolizione dell'opera abusiva.",
    },
  ],
  faq: [
    {
      q: 'Quali sono i principali titoli edilizi in Italia?',
      a: "Sono quattro: edilizia libera (nessun titolo, art. 6 DPR 380/2001), CILA (Comunicazione di Inizio Lavori Asseverata, art. 6-bis), SCIA (Segnalazione Certificata di Inizio Attività, art. 22-23) e Permesso di Costruire (art. 10), in ordine crescente di complessità e di incidenza dell'intervento sull'edificio.",
    },
    {
      q: 'Come faccio a sapere quale pratica edilizia serve per il mio intervento?',
      a: "Dipende da cosa cambia nell'edificio: finiture e impianti senza opere strutturali rientrano in edilizia libera o CILA, interventi strutturali o su un'intera unità immobiliare in SCIA, aumenti di volumetria o modifiche di sagoma in Permesso di Costruire. La qualificazione esatta va sempre verificata con un tecnico abilitato, perché dipende anche dal regolamento comunale.",
    },
    {
      q: 'Chi può presentare una pratica edilizia?',
    ...
    },
    {
      ...
      a: "Le conseguenze variano in base alla gravita': si va da sanzioni pecuniarie fisse (ad esempio per lavori CILA non comunicati) fino, nei casi più gravi di interventi eseguiti senza alcun titolo quando necessario, alla possibile demolizione dell'opera abusiva. E' sempre preferibile regolarizzare la posizione (ove possibile) prima che vengano contestati abusi edilizi.",
    },
    {
